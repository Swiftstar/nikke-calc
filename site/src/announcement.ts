 ...
 *
 * 시각은 **들은 그대로** 적는다 — 이 자리는 이미 한 번 오전·오후를 뒤집어 적었다.
 * 받은 값이 UTC+8이면 그 시간대로 적어 두고, 한국 시간은 아래 주석과 시험이 밝힌다.
 */
export const COUNTDOWNS: Countdown[] = [
  // UTC+8 18:51:01 = 한국 시간 2026-09-09 19:51:01.
  { target: '2026-09-09T18:51:01+08:00', label: '칠무해 석방까지 남은 시간' },
];
